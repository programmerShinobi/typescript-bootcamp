...
class vehiclePurchase implements vehicleInterface {
    ...
    GetTotalVehicleType(purch_vehicleType: string): object {
        ...
        return {
            'Interface Method' : `GetTotalVehicle(${purch_vehicleType})`,
            'Return Value' : count
        }
    }
...
class income extends vehiclePurchase {
    ...
    GetTotalIncomeVehicle(purch_vehicleType: string): object {
        // deklarasikan count
        let count = 0;
        ...
        // Mengembalikan nilai dari variabel 'idCount'
        return {
            'Interface Method' : `GetTotalIncomeVehicle(${purch_vehicleType})`,
            'Return Value' : count
        }
    }
